...
private:
    void ensureJoined();
    int mapPosixPriority(int posixPriority) const;
    void completeRun();
    void runEntry();
    static unsigned long entryPoint(void* arg);
    ...
    void* _handle{nullptr}; ///< Win32 HANDLE (stored as void* to keep windows.h out of the header)
